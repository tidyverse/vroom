...
// vroom_
SEXP vroom_(RObject file, const char delim, const char quote, bool trim_ws, RObject col_names, size_t skip, CharacterVector na, size_t num_threads);
RcppExport SEXP _vroom_vroom_(SEXP fileSEXP, SEXP delimSEXP, SEXP quoteSEXP, SEXP trim_wsSEXP, SEXP col_namesSEXP, SEXP skipSEXP, SEXP naSEXP, SEXP num_threadsSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(vroom_(file, delim, quote, trim_ws, col_names, skip, na, num_threads));
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_vroom_vroom_", (DL_FUNC) &_vroom_vroom_, 8},
    {NULL, NULL, 0}
};
