...
// vroom_
SEXP vroom_(RObject file, const char delim, const char quote, bool trim_ws, bool escape_double, bool escape_backslash, const char comment, RObject col_names, size_t skip, CharacterVector na, size_t num_threads);
RcppExport SEXP _vroom_vroom_(SEXP fileSEXP, SEXP delimSEXP, SEXP quoteSEXP, SEXP trim_wsSEXP, SEXP escape_doubleSEXP, SEXP escape_backslashSEXP, SEXP commentSEXP, SEXP col_namesSEXP, SEXP skipSEXP, SEXP naSEXP, SEXP num_threadsSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(vroom_(file, delim, quote, trim_ws, escape_double, escape_backslash, comment, col_names, skip, na, num_threads));
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_vroom_vroom_", (DL_FUNC) &_vroom_vroom_, 11},
    {NULL, NULL, 0}
};
