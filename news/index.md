...
- [`problems()`](https://vroom.tidyverse.org/reference/problems.md) are
...
- [`vroom::problems()`](https://vroom.tidyverse.org/reference/problems.md)
...
- [`vroom()`](https://vroom.tidyverse.org/reference/vroom.md) reads more
...
- Fixed recursive garbage collection error that could occur during
  [`vroom_write()`](https://vroom.tidyverse.org/reference/vroom_write.md)
  when
  [`output_column()`](https://vroom.tidyverse.org/reference/output_column.md)
  generates an ALTREP vector
  ([\#389](https://github.com/tidyverse/vroom/issues/389)).

- [`vroom_progress()`](https://vroom.tidyverse.org/reference/vroom_progress.md)
  uses
...
- `col_factor(levels = NULL)` honors the `na` strings of
  [`vroom()`](https://vroom.tidyverse.org/reference/vroom.md) and its
...
- [`vroom()`](https://vroom.tidyverse.org/reference/vroom.md) no longer
...
- [`vroom_fwf()`](https://vroom.tidyverse.org/reference/vroom_fwf.md) no
...
- [`vroom()`](https://vroom.tidyverse.org/reference/vroom.md) now parses
...
- [`vroom()`](https://vroom.tidyverse.org/reference/vroom.md) now works
  around specifying a `\n` as the delimiter
...
- [`vroom()`](https://vroom.tidyverse.org/reference/vroom.md) now always
...
- [`vroom()`](https://vroom.tidyverse.org/reference/vroom.md) and
  [`vroom_write()`](https://vroom.tidyverse.org/reference/vroom_write.md)
...
- [`vroom()`](https://vroom.tidyverse.org/reference/vroom.md) now uses
  the tzdb package when parsing date-times
  ([@DavisVaughan](https://github.com/DavisVaughan),
  [\#273](https://github.com/tidyverse/vroom/issues/273))

- [`vroom()`](https://vroom.tidyverse.org/reference/vroom.md) now emits
...
- [`vroom()`](https://vroom.tidyverse.org/reference/vroom.md) now allows
...
- [`vroom()`](https://vroom.tidyverse.org/reference/vroom.md) is now
...
- [`col_datetime()`](https://vroom.tidyverse.org/reference/cols.md) now
...
- [`problems()`](https://vroom.tidyverse.org/reference/problems.md) now
...
- [`vroom()`](https://vroom.tidyverse.org/reference/vroom.md) argument
...
- [`vroom()`](https://vroom.tidyverse.org/reference/vroom.md) now writes
  the column names if given an input with no rows
  ([\#213](https://github.com/tidyverse/vroom/issues/213))

- [`vroom()`](https://vroom.tidyverse.org/reference/vroom.md) columns
...
- [`cols()`](https://vroom.tidyverse.org/reference/cols.md) gains a
  `.delim` argument and
  [`vroom()`](https://vroom.tidyverse.org/reference/vroom.md) now uses
...
- [`vroom()`](https://vroom.tidyverse.org/reference/vroom.md) can now
...
- [`vroom()`](https://vroom.tidyverse.org/reference/vroom.md) now better
...
- [`vroom()`](https://vroom.tidyverse.org/reference/vroom.md) now has an
...
- [`vroom_fwf()`](https://vroom.tidyverse.org/reference/vroom_fwf.md) is
...
- Move example files for
  [`vroom()`](https://vroom.tidyverse.org/reference/vroom.md) out of
  `\dontshow{}`.
