...
* GitHub: <https://github.com/smartiing/seekr>
* Email: <mailto:martingay.sacha@hotmail.com>
* GitHub mirror: <https://github.com/cran/seekr>

Run `revdepcheck::cloud_details(, "seekr")` for more info
