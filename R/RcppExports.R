...
vroom_fwf_ <- function(inputs, col_starts, col_ends, trim_ws, col_names, col_types, col_keep, col_skip, skip, comment, id, na, locale, guess_max, num_threads, altrep_opts) {
    .Call(`_vroom_vroom_fwf_`, inputs, col_starts, col_ends, trim_ws, col_names, col_types, col_keep, col_skip, skip, comment, id, na, locale, guess_max, num_threads, altrep_opts)
}
