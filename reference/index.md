...
- [`vroom()`](https://vroom.r-lib.org/reference/vroom.md) : Read a
...
- [`vroom_fwf()`](https://vroom.r-lib.org/reference/vroom_fwf.md)
  ...
  [`fwf_cols()`](https://vroom.r-lib.org/reference/vroom_fwf.md) : Read
  a fixed width file into a tibble
...
- [`as.col_spec()`](https://vroom.r-lib.org/reference/as.col_spec.md) :
...
- [`cols()`](https://vroom.r-lib.org/reference/cols.md)
  ...
  [`col_guess()`](https://vroom.r-lib.org/reference/cols.md)
  ...
  [`col_time()`](https://vroom.r-lib.org/reference/cols.md) : Create
  column specification
- [`cols_condense()`](https://vroom.r-lib.org/reference/spec.md)
  [`spec()`](https://vroom.r-lib.org/reference/spec.md) : Examine the
  column specifications for a data frame
- [`guess_type()`](https://vroom.r-lib.org/reference/guess_type.md) :
...
- [`locale()`](https://vroom.r-lib.org/reference/locale.md)
  [`default_locale()`](https://vroom.r-lib.org/reference/locale.md) :
  Create locales
...
- [`gen_tbl()`](https://vroom.r-lib.org/reference/gen_tbl.md) : Generate
  a random tibble
- [`gen_character()`](https://vroom.r-lib.org/reference/generators.md)
  [`gen_double()`](https://vroom.r-lib.org/reference/generators.md)
  [`gen_number()`](https://vroom.r-lib.org/reference/generators.md)
  [`gen_integer()`](https://vroom.r-lib.org/reference/generators.md)
  [`gen_factor()`](https://vroom.r-lib.org/reference/generators.md)
  [`gen_time()`](https://vroom.r-lib.org/reference/generators.md)
  [`gen_date()`](https://vroom.r-lib.org/reference/generators.md)
  [`gen_datetime()`](https://vroom.r-lib.org/reference/generators.md)
  [`gen_logical()`](https://vroom.r-lib.org/reference/generators.md)
  [`gen_name()`](https://vroom.r-lib.org/reference/generators.md) :
...
- [`vroom_altrep()`](https://vroom.r-lib.org/reference/vroom_altrep.md)
  : Show which column types are using Altrep
- [`vroom_example()`](https://vroom.r-lib.org/reference/vroom_example.md)
  [`vroom_examples()`](https://vroom.r-lib.org/reference/vroom_example.md)
