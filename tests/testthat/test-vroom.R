...
test_that("handles quotes within skips", {
  ...
  test_vroom(data,
    col_names = c("a", "b", "c"), skip = 2, quote = "", delim = "\t",
    equals = tibble::tibble(
      a = c("2a", "3a", "4a"),
      b = c("2b", "3b", "4b"),
      c = c("2c\"", "3c\"", "4c")
  ...
  test_vroom(data,
    col_names = c("a", "b", "c"), skip = 3, quote = "", delim = "\t",
    equals = tibble::tibble(
      a = c("3a", "4a"),
      b = c("3b", "4b"),
      c = c("3c\"", "4c")
  ...
  test_vroom(data,
    col_names = c("a", "b", "c"), skip = 4, quote = "", delim = "\t",
    equals = tibble::tibble(
      a = c("4a"),
      b = c("4b"),
      c = c("4c")
