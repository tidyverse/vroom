...
[![Codecov test coverage](https://codecov.io/gh/tidyverse/vroom/graph/badge.svg)](https://app.codecov.io/gh/tidyverse/vroom)
<!-- badges: end -->

```{r echo = FALSE, message = FALSE}
tm <- vroom::vroom(system.file("bench", "taxi.tsv", package = "vroom"))
versions <- vroom::vroom(system.file(
  "bench",
  "session_info.tsv",
  package = "vroom"
))
...
But that's impossible! How can it be [so fast](https://vroom.tidyverse.org/articles/benchmarks.html)?
...
- [Getting started with vroom](https://vroom.tidyverse.org/articles/vroom.html)
...
see the [benchmark article](https://vroom.tidyverse.org/articles/benchmarks.html)
