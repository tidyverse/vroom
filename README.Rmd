...
tm <- readRDS(system.file("bench", "timings.Rds", package = "vroom"))
library(dplyr)
...
vroom has most of the parsing features of [readr](https://readr.tidyverse.org), including
...
change the option to 'Manual Refresh Only' in the environment pane.
