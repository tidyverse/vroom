...
The fastest delimited reader for R, **`r filter(tbl, package == "vroom") %>% pull("throughput") %>% paste0("/sec") %>% trimws()`**.
...
- [Getting started with vroom](https://r-lib.github.io/vroom/articles/vroom.html)
...
- [Matt Dowle](https://twitter.com/mattdowle) and the rest of the [Rdatatable](https://github.com/Rdatatable) team, `data.table::fread()` is blazing fast and great motivation to see how fast we could goo faster!
