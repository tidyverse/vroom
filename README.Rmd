...
There are also a family of variables to control whether the altrep framework is used fo

- `VROOM_USE_ALTREP_NUMERICS` - If set use altrep for _all_ numeric types (default `FALSE`).
