...
The benchmarks were run on a Amazon EC2
...
```{r, fig.height = 8, fig.width=10, warning = FALSE, message = FALSE, echo = FALSE}
all_chr_wide <- read_benchmark(system.file("bench", "all_character_wide-times.tsv", package = "vroom"), desc)
...
*Note the current CRAN version of data.table (1.12.2) does not support writing directly to gzip compressed files, though the development version (1.12.3) does *
