...
plot_benchmark <- function(data, title) {
  ...
  subtitle <- glue::glue("{rows} x {cols} - {size}B")
...
plot_benchmark(taxi, "Time to analyze trip fare data")
...
For these reasons (and becuase the data.table implementation is very fast)
