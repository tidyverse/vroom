...
For the benchmark the first 2,500,000 lines of the first four taxi trip fare
files were used, for a total of 10,000,000 lines.
...
taxi_writing %>%
  select(-size, -rows, -cols, -type, -altrep, -label, -method) %>%
