...
The dataset used in these benchmarks is from Freedom of Information Law (FOIL)
...
[bench/benchmark.R](https://github.com/r-lib/vroom/blob/master/inst/bench/benchmark.R).
