...
- [`str()`](https://rdrr.io/r/utils/str.html) now works in a colorized
  ...
  with
  [`col_big_integer()`](https://vroom.r-lib.org/dev/reference/cols.md)
...
- [`vroom::problems()`](https://vroom.r-lib.org/dev/reference/problems.md)
...
- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) reads more
...
- [`vroom_format()`](https://vroom.r-lib.org/dev/reference/vroom_format.md)
  and
...
- Fixed recursive garbage collection error that could occur during
  [`vroom_write()`](https://vroom.r-lib.org/dev/reference/vroom_write.md)
  when
  [`output_column()`](https://vroom.r-lib.org/dev/reference/output_column.md)
  generates an ALTREP vector
  ([\#389](https://github.com/tidyverse/vroom/issues/389)).

- [`vroom_progress()`](https://vroom.r-lib.org/dev/reference/vroom_progress.md)
  uses
...
- `col_factor(levels = NULL)` honors the `na` strings of
  [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) and its
  own `include_na` argument, as described in the docs, and now
...
- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) no longer
...
- [`vroom_fwf()`](https://vroom.r-lib.org/dev/reference/vroom_fwf.md) no
...
- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) now
...
- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) now parses
...
- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) now works
  around specifying a `\n` as the delimiter
...
- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) now always
...
- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) and
  [`vroom_write()`](https://vroom.r-lib.org/dev/reference/vroom_write.md)
...
- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md),
  [`vroom_fwf()`](https://vroom.r-lib.org/dev/reference/vroom_fwf.md)
  and
  [`vroom_lines()`](https://vroom.r-lib.org/dev/reference/vroom_lines.md)
...
- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) now uses
  the tzdb package when parsing date-times
  ([@DavisVaughan](https://github.com/DavisVaughan),
  [\#273](https://github.com/tidyverse/vroom/issues/273))

- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) now emits
  a warning of class `vroom_parse_issue` if there are non-fatal parsing
  issues.

- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) now emits
  a warning of class `vroom_mismatched_column_name` if the user supplies
  a column type that does not match the name of a read column
...
- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) now allows
...
- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) is now
...
- [`col_datetime()`](https://vroom.r-lib.org/dev/reference/cols.md) now
...
- [`vroom_write_lines()`](https://vroom.r-lib.org/dev/reference/vroom_write_lines.md)
...
- [`problems()`](https://vroom.r-lib.org/dev/reference/problems.md) now
...
- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) argument
...
- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) now writes
  the column names if given an input with no rows
  ([\#213](https://github.com/tidyverse/vroom/issues/213))

- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) columns
  now support indexing with NA values
...
- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) now works
  when the `na` argument is encoded in non ASCII or UTF-8 locales *and*
  the file encoding is not the same as the native encoding
...
- [`cols()`](https://vroom.r-lib.org/dev/reference/cols.md) gains a
  `.delim` argument and
  [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) now uses
  it as the delimiter if it is provided
...
- [`fwf_empty()`](https://vroom.r-lib.org/dev/reference/vroom_fwf.md)
  now uses the `skip` parameter, as intended.

- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) can now
  read single line files without a terminal newline
  ([\#173](https://github.com/tidyverse/vroom/issues/173)).

- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) can now
  select the id column if provided
...
- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) now better
...
- [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) now has an
...
- [`vroom_fwf()`](https://vroom.r-lib.org/dev/reference/vroom_fwf.md) is
  now more robust if not all lines are the expected length
...
- [`vroom_str()`](https://vroom.r-lib.org/dev/reference/vroom_str.md)
...
- Move example files for
  [`vroom()`](https://vroom.r-lib.org/dev/reference/vroom.md) out of
  `\dontshow{}`.
